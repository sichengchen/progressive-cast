...
//#endregion
//#region ../../node_modules/.pnpm/dexie@4.0.11/node_modules/dexie/import-wrapper.mjs
		...
		***************************************************************************** */
		...
		function parseIndexSyntax(primKeyAndIndexes) {
			return primKeyAndIndexes.split(",").map(function(index, indexNum) {
				...
				var keyPath = name.startsWith("[") ? name.match(/^\[(.*)\]$/)[1].split("+") : name;
				...
				case "query":
					...
					return [
						entries.find(function(entry) {
							return ("limit" in entry.req ? entry.req.limit : Infinity) >= req.limit && (req.values ? entry.req.values : true) && isSuperRange(entry.req.query.range, req.query.range);
						}),
						false,
						tblCache,
						entries
		...
		if (typeof addEventListener !== "undefined") {
			addEventListener("pagehide", function(event) {
				if (!Dexie$1.disableBfCache && event.persisted) {
					...
					for (var _i = 0, connections_1 = connections; _i < connections_1.length; _i++) connections_1[_i].close({ disableAutoOpen: false });
				}
			});
...
var { liveQuery, mergeRanges, rangesOverlap, RangeSet, cmp, Entity, PropModification, replacePrefix, add, remove } = Dexie;
//#endregion
export { Dexie, Dexie as default, Entity, PropModification, RangeSet, add, cmp, liveQuery, mergeRanges, rangesOverlap, remove, replacePrefix };
