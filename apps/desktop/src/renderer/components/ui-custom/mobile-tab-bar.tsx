...
const MobileTabBar = React.forwardRef<HTMLDivElement, MobileTabBarProps>(
  (
    {
      items,
      activeTab,
...
const MobileTabBarButton = React.forwardRef<HTMLButtonElement, MobileTabBarButtonProps>(
